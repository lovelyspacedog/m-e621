...
- On the landing page, the short commit hash sits as small text under the bottom-right of the PawDeck title (links to GitHub); other screens still show it in the app bar title so a self-host knows which build is running.
