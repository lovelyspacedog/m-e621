...
- **Local library** — browse one or more folders on disk as a combined library with fuzzy search, `folder:Name` filter, heart favorites for Suggester/Analyzer, remux, and portable sidecars (Chromium or the Tauri desktop build).
