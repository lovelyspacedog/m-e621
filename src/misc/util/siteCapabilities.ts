...
export const isDedicatedChromeMode = (mode: SiteMode): boolean =>
  mode === "tailspace" || mode === "news" || mode === "u18chan";
...
/**
 * `/pools` + pool reader — e621-family, Furbooru galleries, Inkbunny pools
 * (open-by-id), plus Federated (listable children + Inkbunny watch/reader;
