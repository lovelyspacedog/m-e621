...
/**
 * Weasyl site icon.
 * Path from Iconify cib:weasyl (CoreUI Brands), CC0 1.0.
 * https://icon-sets.iconify.design/cib/weasyl/
 */
export const WeasylIcon = defineComponent({
  name: "WeasylIcon",
  setup() {
    return () =>
      h(
