...
/**
 * e6ai site icon — Iconify `pajamas:tanuki-ai`
 * (MIT: https://gitlab.com/gitlab-org/gitlab-svgs/-/blob/main/LICENSE).
 */
export const TanukiAiIcon = defineComponent({
  name: "TanukiAiIcon",
  setup() {
    return () =>
      h(
