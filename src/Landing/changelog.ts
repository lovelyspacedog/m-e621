...
export const changelogSections: ChangelogSection[] = [
  {
    ...
    items: [
      ...
      "More one-time tips (Reset tooltips): Federated Following, Local library, Layout shortcuts, pool origin/watched badges, pool reader, fullscreen gestures, Saved posts, blacklist modes, Tailspace comics, Fluffle, remux, Suggester, Analyzer, Flayrah offline cache, starred tags",
